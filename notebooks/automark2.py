...
# OpenCV images are BGR, whereas matplotlib expects RGB.
plt.imshow(cv2.blur(cv2.cvtColor(i, cv2.COLOR_BGR2RGB), (64, 64)))
...
import wandb
wandb.finish()
wandb_logger = pl.loggers.WandbLogger(project="mel-automark2", name="dense_1cyclelr_600epochs_075lr_defaultdiv_defaultanneal_blur64")
