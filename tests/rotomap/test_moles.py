...
class TestAddMole:
    def test_add_mole_auto_uuid(self) -> None:
        m = []
    ...
    def test_add_mole_explicit_uuid(self) -> None:
        m = []
...
class TestNearestMole:
    def test_single_mole(self) -> None:
        m = [_make_mole(10, 10, "a")]
        assert moles.nearest_mole_index(m, 0, 0) == 0

    def test_selects_closest(self) -> None:
        m = [
            _make_mole(0, 0, "a"),
    ...
    def test_distance_value(self) -> None:
        m = [_make_mole(3, 4, "a")]
...
class TestSetGetNearestMoleUuid:
    ...
    def test_set_uuid_not_canonical(self) -> None:
        m = [_make_mole(10, 10, "old")]
    ...
    def test_get_uuid_empty(self) -> None:
        assert moles.get_nearest_mole_uuid([], 0, 0) is None

    def test_set_empty_noop(self) -> None:
        m = []
...
class TestMoveRemoveMole:
    ...
    def test_move_empty_noop(self) -> None:
        m = []
    ...
    def test_remove_empty_noop(self) -> None:
        m = []
...
class TestMoleData:
    ...
    def test_uuid_points(self) -> None:
...
class TestMoleListDiff:
    def test_new_and_missing(self) -> None:
        old = {"a", "b", "c"}
        new = {"b", "c", "d"}
...
class TestNormalisedEllipseMask:
    ...
    def test_small_rotation_unchanged(self) -> None:
...
class TestValidateEllipseMask:
    ...
    def test_out_of_bounds_exceeds_max(self) -> None:
        with pytest.raises(ValueError, match="out of bounds"):
