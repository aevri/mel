...
def test_benchmark_automark3():
    ...
    with chtempdir_context():
        ...
        try:
            # Run mel rotomap automark3 with small model for speed
            expect_ok(
                "mel",
                "rotomap",
                "automark3",
            ...
            print(f"\nBenchmark Results for automark3:")
            print(f"  Original moles removed: {len(removed_moles)}")
            print(f"  Moles found by automark3: {performance_metrics['moles_found']}")
            ...
            # Performance baseline - automark3 should perform at least as well as guess commands
            # Target: find all 3 moles, match at least 2 within 50 pixels
